...
| T-003 | planned | unassigned | Create reproducible Supabase schema and migration assets | SQL migration files, setup docs | O-003 resolved: use raw SQL files in `migrations/` directory |
